...
#ifndef DX_NON_MODEL
	int						ShaderInitializeModelFlag ;				// モデル用のシェーダーバイナリのセットアップが完了しているかどうかのフラグ( TRUE:完了している  FALSE:完了していない )
...
#ifndef DX_NON_MODEL
extern	int		ShaderCodeSetup_Model( void ) ;																				// ３Ｄモデル用のシェーダーコードのセットアップを行う
